...
<div class="login" id="body">
   <h2 id="main-title">LOGIN</h2>
      <div class="loginform">
         <div>
            <input type="text" placeholder="Id" class="userID"><br>
            <input type="password" placeholder="Password" class="userID">
         </div>
         <input type="button" value="로그인" id="button" onclick="login();">
      </div>
   <div class="img">
      <a href=""><img src="../resources/image/google.png" width="40px" height="40px" class="snsimg"></a>
      <a href=""><img src="../resources/image/naver.png"   width="40px" height="40px" class="snsimg"></a>
      <a id="kakao-login" onclick="loginKakao();"><img src="../resources/image/kakao.png" width="40px" height="40px" class="snsimg"></a> <br>
   </div>
   <div class="find">
