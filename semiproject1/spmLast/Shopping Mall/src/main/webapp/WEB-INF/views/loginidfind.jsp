...
<div id="body">
	...
	<div>
		<form action="/login/useridfind" method="post">
			<input type="text" placeholder="name" id="idName" name="userName"><br>
			<input type="text" placeholder="e-mail" id="idEmail" name="userEmail"><br>
			<input type="submit" value="check" id="idButton">
		</form>
	</div>
	<!-- 이름과 이메일이 일치하지 않을 때-->
	<c:if test="${check == 1}">
