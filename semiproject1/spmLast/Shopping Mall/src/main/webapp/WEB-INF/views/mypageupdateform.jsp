...
<form action="/mypage/mypageupdate">
	...
	<div class="mypageupdate-id">
		...
		<div id="mypageupdate-idinput-div">
			<input type="text" id="mypageupdate-id-input" name="userID" value="${userdto.userID }"> 
	...
	<div class="mypageupdate-pw">
		...
		<div id="mypageupdate-pwinput-div">
			<input type="password" id="mypageupdate-pw-input" name="userPW" value="${userdto.userPW }"> 
	...
	<div class="mypageupdate-pwck">
		...
		<div id="mypageupdate-pwckinput-div">
			<input type="password" name="mypagepwck" id="mypageupdate-pwck-input" value="${userdto.userPW }">
		</div>
	</div>
	...
	<div class="mypageupdate-name">
		...
		<div id="mypageupdate-nameinput-div">
			<input type="text" id="mypageupdate-name-input" name="userName" value="${userdto.userName }">
		</div>
	</div>
	...
	<div class="mypageupdate-addr">
		...
		<div id="myapgeupdate-addrinput-div">
			<div>
				<input type="text" id="mypageupdate-addr-first" name="userAddrMain" value="${userdto.userAddrMain }"> 
				<label id="mypageupdate-addrfirst-content">기본 주소(도로명 주소)</label>
			</div>
			<div>
				<input type="text" id="mypageupdate-addr-last" name="userAddrSub" value="${userdto.userAddrSub }"> 
	...
	<div class="mypageupdate-phone">
		...
		<div id="mypageupdate-phoneinput-div">
			<input type="text" id="mypageupdate-phone-input" name="userPhone" value="${userdto.userPhone }">
		</div>
	</div>
	...
	<div class="mypageupdate-email">
		...
		<div id="mypageupdate-emailinput-div">
			<input type="email" id="mypageupdate-email-input" name="userEmail" value="${userdto.userEmail }">
		</div>
	</div>
	<div class="mypageupdate-bt">
		<input type="submit" value="회원 정보 수정" id="mypageupdate-updatebt">
