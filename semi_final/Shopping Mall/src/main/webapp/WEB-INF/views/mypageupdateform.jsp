...
<form action="/mypage/mypageupdate">
	...
	<div class="mypageupdate-id">
		...
		<div id="mypageupdate-idinput-div">
			<input type="text" class="inputread" id="mypageupdate-id-input" name="userID" value="${userdto.userID }" disabled> 
	...
	<div class="mypageupdate-pw">
		...
		<div id="mypageupdate-pwinput-div">
			<input type="password" class="inputread" id="mypageupdate-pw-input" name="userPW" value="${userdto.userPW }" readonly="readonly"> 
	...
	<div class="mypageupdate-pwck">
		...
		<div id="mypageupdate-pwckinput-div">
			<input type="password" class="inputread" name="mypagepwck" id="mypageupdate-pwck-input" value="${userdto.userPW }" readonly="readonly">
		</div>
	</div>
	...
	<div class="mypageupdate-name">
		...
		<div id="mypageupdate-nameinput-div">
			<input type="text" class="inputread" id="mypageupdate-name-input" name="userName" value="${userdto.userName }" readonly="readonly">
		</div>
	</div>
	...
	<div class="mypageupdate-addr">
		...
		<div id="myapgeupdate-addrinput-div">
			<div>
				<input type="text" class="inputread" id="mypageupdate-addr-first" name="userAddrMain" value="${userdto.userAddrMain }" readonly="readonly"> 
				<label id="mypageupdate-addrfirst-content">기본 주소(도로명 주소)</label>
			</div>
			<div>
				<input type="text" class="inputread" id="mypageupdate-addr-last" name="userAddrSub" value="${userdto.userAddrSub }" readonly="readonly"> 
	...
	<div class="mypageupdate-phone">
		...
		<div id="mypageupdate-phoneinput-div">
			<input type="text" class="inputread" id="mypageupdate-phone-input" name="userPhone" value="${userdto.userPhone }" readonly="readonly">
		</div>
	</div>
	...
	<div class="mypageupdate-email">
		...
		<div id="mypageupdate-emailinput-div">
			<input type="email" class="inputread" id="mypageupdate-email-input" name="userEmail" value="${userdto.userEmail }" readonly="readonly">
		</div>
	</div>
	<div class="mypageupdate-bt">
		<input type="button" class="updatebtn" value="회원 정보 수정" id="mypageupdate-updatebt" onclick="updateform();">
